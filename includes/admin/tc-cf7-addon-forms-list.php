...
/**
 * TC_CF7_Addon Forms_List
 *
 * @class    TC_CF7_Addon_Forms_List
 * @package  TC_CF7_Addon\Forms_List
 * @version  1.0.0
 */

/**
 * TC_CF7_Addon_Forms_List class.
 */
class TC_CF7_Addon_Forms_List extends WP_List_Table {
    ...
    public function get_columns()
    {
        return $columns = array(
            'name'       => __('Name', 'tc-cf7-addon'),
            'count' => __('Count', 'tc-cf7-addon'),
        );
    }
